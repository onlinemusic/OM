...
<ul>
    ...
    <li><a href="http://localhost:8080/admin/musicList"><i class="ti-bar-chart-alt"></i>  音乐列表 </a>

    </li>
    <li><a href="http://localhost:8080/admin/uploadMusicPage"><i class="ti-calendar"></i> 音乐上传 </a></li>

    <li class="label">用户管理</li>
    <li><a href="http://localhost:8080/admin/userList"><i class="ti-layout"></i> <span>用户列表</span></a>
